...
#else
#define tr_debug(format, ...) debug_if(true, format "\n", ## __VA_ARGS__)
#define tr_info(format, ...)  debug_if(true, format "\n", ## __VA_ARGS__)
#define tr_warn(format, ...)  debug_if(true, format "\n", ## __VA_ARGS__)
#define tr_error(format, ...) debug_if(true, format "\n", ## __VA_ARGS__)
#endif
